    ...
    },
    {
        ...
        submenu: [            
            ...
            },
            {
                label: 'Timeline',
                click (item, focusedWindow) {
                    focusedWindow.webContents.send('toggle panel', 'timeline')
                }
            },
            {
                label: 'Inspector',
            ...
            },
            {
                label: 'Cutscenes',
                click (item, focusedWindow) {
                    focusedWindow.webContents.send('toggle panel', 'cutscenes')
                }
            },
            {
                label: 'Commands',
                click (item, focusedWindow) {
                    focusedWindow.webContents.send('toggle panel', 'commands')
                }
            },
            {
                label: 'Puppets',
