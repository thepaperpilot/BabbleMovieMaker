...
exports.init = function() {
	...
	currPriority = 0
	counts = {}
	exports.info("Babble Movie Maker version: " + remote.app.getVersion())
...
exports.log = function(string, priority, tolerance) {
	if (currPriority === 3 && priority === 3 && tolerance === 3) {
		let statuses = status.innerText.split('\n')
		status.innerText = statuses.slice(0, statuses.length - 1).join('\n')
	}
